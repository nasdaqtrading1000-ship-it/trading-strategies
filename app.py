...
def create_app():
    ...
    def stripe_checkout_session(product_key, plan_key, plan, payment_id, user):
        ...
        payload = {
            ...
            "metadata[account_email]": user.get("email") or "",
    ...
    def index():
        ...
        SELECT s.id, s.name, s.description, s.risk_level, s.signal_frequency,
               ...
               s.run_txt_updated, s.run_returncode, s.include_in_totalizer, s.public_visible, s.web_visible,
               s.replicator_available, s.is_active,
